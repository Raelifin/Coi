...
public class MD2Parser extends AParser implements IParser {
	...
	public MD2Parser(Resources resources, String resourceID, boolean generateMipMap, String packageID) {
		super(resources, resourceID, generateMipMap, packageID);
	}
	...
	@Override
	public void parse() {
		InputStream fileIn = resources.openRawResource(resources.getIdentifier(resourceID, null, packageID));
