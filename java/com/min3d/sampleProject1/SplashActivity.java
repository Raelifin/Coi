...
import com.raelifin.coi.CoiEngine;
import com.raelifin.coi.R;
...
public class SplashActivity extends ListActivity  
{
	...
	private ItemVo[] _items = {
			...
			new ItemVo("Minimal example", CoiEngine.class, "ExampleMostMinimal.java"),
    ...
    public boolean onOptionsItemSelected(MenuItem item) 
    {
        ...
        switch (item.getItemId()) 
        {
            case 0:
            	...
            	i.setData(Uri.parse("http://code.google.com/p/min3d"));
            	startActivity(i);                
            	return true;
                
            case 1:
            	i = new Intent(Intent.ACTION_VIEW);
            	i.setData(Uri.parse("http://www.zeropointnine.com/blog"));
            	startActivity(i);                
            	return true;
        }
        return false;
